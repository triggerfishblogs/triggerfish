...
2. User type: select **External** (or **Internal** if you're on a Google
   Workspace organization and only want org users)
3. Click **Create**
...
can authorize. This is fine for personal use. Publishing the app removes the
...
A browser window will open for you to grant access. After authorization, tokens
...
- The [No Write-Down rule](/security/no-write-down) applies: CONFIDENTIAL Google
