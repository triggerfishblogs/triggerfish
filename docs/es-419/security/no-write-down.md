...
- [Identidad y autenticación](/es-419/security/identity) — cómo se establece la identidad de canal
- [Auditoría y cumplimiento](/es-419/security/audit-logging) — cómo se registran las acciones bloqueadas
- [Arquitectura: Taint y sesiones](/es-419/architecture/taint-and-sessions) — mecánica detallada del
  taint de sesión
