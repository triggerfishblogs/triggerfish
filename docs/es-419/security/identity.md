...
- [Regla de no write-down](/es-419/security/no-write-down) — cómo se aplica el flujo de clasificación
- [Delegación de agentes](/es-419/security/agent-delegation) — verificación de identidad de agente a agente
- [Auditoría y cumplimiento](/es-419/security/audit-logging) — cómo se registran las decisiones de identidad
