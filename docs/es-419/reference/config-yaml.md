...
al iniciar. Vea
[Gestion de Secretos](/es-419/security/secrets#secret-references-in-configuration)
para detalles. :::
...
| `vision`                         | string   | Modelo de vision opcional para descripcion automatica de imagenes (vea [Imagen y Vision](/es-419/features/image-vision)) |
...
[Cron y Triggers](/es-419/features/cron-and-triggers) para detalles.

### `notifications`

Preferencias de entrega de notificaciones. Vea
[Notificaciones](/es-419/features/notifications) para detalles.
...
Vea [Busqueda Web y Fetch](/es-419/features/web-search) para detalles.
...
Vea [Logging Estructurado](/es-419/features/logging) para detalles sobre salida
...
Vea la guia de [Integracion GitHub](/es-419/integrations/github) para
