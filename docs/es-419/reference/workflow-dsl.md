...
uso y ejemplos, consulta
[Flujos de trabajo](/es-419/features/workflows).
...
| Field                     | Type         | Required | Description                                              |
| ------------------------- | ------------ | -------- | -------------------------------------------------------- |
| `document`                | object       | yes      | Metadatos del documento (ver arriba)                     |
...
| Field  | Type   | Required | Description                                            |
| ------ | ------ | -------- | ------------------------------------------------------ |
| `call` | string | yes      | Tipo de llamada (ver tabla de despacho abajo)          |
...
Ramificación condicional. El campo `switch` es un arreglo de entradas de caso.
Cada caso es un objeto de una sola clave donde la clave es el nombre del caso.

| Case field | Type   | Required | Description                                                   |
| ---------- | ------ | -------- | ------------------------------------------------------------- |
| `when`     | string | no       | Condición de expresión. Omitir para el caso predeterminado.   |
...
Duraciones comunes: `PT1S` (1 segundo), `PT30S` (30 segundos), `PT1M`
...
`${ }`, se devuelve el valor con tipo crudo (número, booleano, objeto, arreglo).
...
| Arreglo no vacío              | sí          |
| Objeto                        | sí          |
| `false`, `0`, `""`, `null`, `undefined`, arreglo vacío | no |
...
| `classification` | string | Nivel de clasificación al momento de guardar       |
