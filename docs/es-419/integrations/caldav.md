...
::: info Para Google Calendar, usa la integración de [Google Workspace](/es-419/integrations/google-workspace)
...
- [Google Workspace](/es-419/integrations/google-workspace) -- Para Google Calendar
  (usa API nativa)
- [Cron y Triggers](/es-419/features/cron-and-triggers) -- Programar acciones del agente
  basadas en calendario
- [Guía de clasificación](/es-419/guide/classification-guide) -- Cómo elegir el nivel
