...
El vault o carpeta específica tiene un nivel de clasificación que entra en conflicto con el taint de sesión. Consulta [Solución de problemas de seguridad](/es-419/support/troubleshooting/security) para detalles sobre las reglas de write-down.
