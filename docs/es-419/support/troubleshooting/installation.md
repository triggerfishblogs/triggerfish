...
Si la auto-instalación falla, instala `signal-cli` manualmente y asegúrate de que esté en tu PATH. Consulta los [docs del canal Signal](/es-419/channels/signal) para pasos de configuración manual.
