...
2. **Revisa las guías de solución de problemas.** La sección de [Solución de problemas](/es-419/support/troubleshooting/) cubre la mayoría de los problemas comunes.

3. **Revisa los problemas conocidos.** La página de [Problemas conocidos](/es-419/support/kb/known-issues) lista los problemas de los que ya estamos al tanto.
...
Adjunta un [paquete de logs](/es-419/support/guides/collecting-logs):
