...
Si encuentras un problema no listado aquí, revisa la página de [GitHub Issues](https://github.com/greghavens/triggerfish/issues). Si no está reportado, reporta un nuevo issue siguiendo la [guía de reporte](/es-419/support/guides/filing-issues).
