...
— suscríbete a un [plan Pro o Power](/es-419/pricing), y tu agente se conecta a
...
- **Conecta integraciones** -- `triggerfish connect google` para Google Workspace,
  `triggerfish connect github` para GitHub. Consulta [Integraciones](/es-419/integrations/).
