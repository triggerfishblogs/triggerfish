...
**Model ID formats.** Fireworks accepts several model ID patterns. The wizard normalizes common formats, but if verification fails, check the [Fireworks model library](https://fireworks.ai/models) for the exact ID.
