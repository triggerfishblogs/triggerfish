...
Telegram has a 4,096-character limit per message. Long responses are automatically chunked. This is normal behavior.
...
This is a known limitation. See [Known Issues](/support/kb/known-issues).
