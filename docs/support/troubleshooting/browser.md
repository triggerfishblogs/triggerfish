...
If you see unexpected profile behavior, the profile directory may be corrupted. Delete it and let Triggerfish create a fresh one on the next browser launch.
