...
<h2>Pautan persediaan tidak sah</h2>
<p>Halaman ini dibuka secara automatik oleh <code>triggerfish dive</code>.<br>Jalankan wizard persediaan dalam terminal anda untuk bermula.</p>
</div>

<div id="checkout-flow" class="checkout-wrapper" style="display:none;">
<div class="checkout-header">
<h1>Pilih pelan anda</h1>
<p>Ejen anda sedang menunggu — pilih pelan untuk menyelesaikan persediaan.</p>
</div>
<div class="checkout-grid">
<div class="checkout-card">
<h3>Pro</h3>
<div class="price">$49<span>/bulan</span></div>
<div class="subtitle">Semua yang anda perlukan.</div>
<ul>
<li>Inferens AI disertakan</li>
<li>Carian web disertakan</li>
<li>Terowong awan untuk webhook</li>
<li>Tugas berjadual</li>
<li>Tiada kunci API untuk diuruskan</li>
</ul>
<button class="checkout-btn" data-plan="pro">Langgan</button>
</div>
<div class="checkout-card">
<h3>Power</h3>
<div class="price">$199<span>/bulan</span></div>
<div class="subtitle">Penggunaan 5x lebih banyak dari Pro.</div>
<ul>
<li>Semua dalam Pro</li>
<li>Had penggunaan yang lebih tinggi</li>
<li>Lebih banyak sesi serentak</li>
<li>Pelbagai terowong awan</li>
<li>Respons AI yang lebih panjang</li>
</ul>
<button class="checkout-btn" data-plan="power">Langgan</button>
</div>
</div>
...
onMounted(() => {
  ...
  document.querySelectorAll('button.checkout-btn[data-plan]').forEach(btn => {
    btn.addEventListener('click', async () => {
      ...
      btn.textContent = 'Mengalih ke pembayaran...'
      ...
      try {
        ...
        if (data.checkout_url) {
          ...
          showError(btn, plan, errorEl, data.error || 'Sesi pembayaran gagal')
        }
      } catch (err) {
        showError(btn, plan, errorEl, 'Tidak dapat mencapai gateway Triggerfish')
      }
    })
  })
