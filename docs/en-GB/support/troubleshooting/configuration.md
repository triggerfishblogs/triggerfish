...
- **Provider does not list the model.** Some providers (Fireworks) use different naming formats. The wizard normalises common patterns, but unusual model IDs may not match.
