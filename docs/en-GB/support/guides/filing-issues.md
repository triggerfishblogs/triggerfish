...
2. **Check the troubleshooting guides.** The [Troubleshooting section](/en-GB/support/troubleshooting/) covers most common problems.

3. **Check known issues.** The [Known Issues](/en-GB/support/kb/known-issues) page lists problems we are already aware of.
...
Attach a [log bundle](/en-GB/support/guides/collecting-logs):
