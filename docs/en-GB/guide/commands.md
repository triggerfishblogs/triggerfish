...
OAuth Client ID and Client Secret, opens a browser for authorisation, and stores
...
| `/compact`              | Compress conversation history using LLM summarisation         |
...
tool call parsing, and agent loop behaviour. Enable it by setting the
