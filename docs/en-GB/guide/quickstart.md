...
— subscribe to a [Pro or Power plan](/en-GB/pricing), and your agent connects to
...
Step 2/8: Name your agent and set its personality
  Agent name: Reef
  Mission (one sentence): Help me stay organised and informed
...
- **Customise your agent** -- edit `~/.triggerfish/SPINE.md` to refine your
...
- **Set up proactive behaviour** -- create a `~/.triggerfish/TRIGGER.md` to tell
