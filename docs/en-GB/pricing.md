...
<div class="pricing-card">
  ...
  <a href="/en-GB/guide/installation" class="cta secondary">Install Now</a>
</div>
...
1. **Subscribe** above — you'll receive your licence key by email after checkout
2. **Run `triggerfish dive --force`** and select Triggerfish Gateway as your provider
3. **Enter your licence key** or use the magic link flow to activate automatically
...
Your licence key is stored in your OS keychain. You can manage your subscription
...
Triggerfish Gateway routes through optimised model infrastructure. The model
selection is managed for you — we pick the best cost/quality tradeoff and handle
caching, failover, and optimisation automatically.
