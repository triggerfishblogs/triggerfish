...
misbehaviour. See the full [Security-First Design](/en-GB/security/) page for the deep
...
| Responsible Disclosure Programme | <StatusBadge status="active" />  | Documented vulnerability reporting process with defined response timelines. See [disclosure policy](/en-GB/security/responsible-disclosure).              |
...
## Defence in Depth — 13 Independent Layers
...
Read the full [Defence in Depth](/en-GB/architecture/defense-in-depth) architecture
documentation.
...
[Responsible Disclosure Policy](/en-GB/security/responsible-disclosure). Do not open
