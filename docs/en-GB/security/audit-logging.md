...
it, and was it ever sent outside the organisation?
...
Transformations:
  ...
  --> LLM summarised 3 records into pipeline overview
...
retention period below your organisation's regulatory requirement is the
