...
the setup wizard. See the [installation guide](/en-GB/guide/installation) for Docker
setup, building from source, and the release process.

Don't want to manage API keys? [See pricing](/en-GB/pricing) for Triggerfish Gateway —
...
- **Agent Identity** — Your agent's mission lives in SPINE.md, proactive
  behaviours in TRIGGER.md. Skills extend capabilities through simple folder
