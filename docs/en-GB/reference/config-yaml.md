...
[Secrets Management](/en-GB/security/secrets#secret-references-in-configuration) for
details. :::
...
| `vision`                         | string   | Optional vision model for automatic image description (see [Image and Vision](/en-GB/features/image-vision)) |
...
[Cron and Triggers](/en-GB/features/cron-and-triggers) for details.

### `notifications`

Notification delivery preferences. See [Notifications](/en-GB/features/notifications)
for details.
...
See [Web Search and Fetch](/en-GB/features/web-search) for details.
...
See [Structured Logging](/en-GB/features/logging) for details on log output and file
rotation.
...
See the [GitHub Integration](/en-GB/integrations/github) guide for full setup
instructions.
