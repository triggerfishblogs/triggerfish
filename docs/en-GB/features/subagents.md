...
- Summarise a long document without filling the main context
...
| `llm_task` | Single-shot reasoning, summarisation, or classification |
...
from multiple specialised perspectives iterating on each other's work.
