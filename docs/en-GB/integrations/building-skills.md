...
name: github-triage
description: >
  Triage GitHub notifications and issues. Categorise by priority,
  summarise new issues, and flag PRs needing review.
...
const result = await author.create({
  name: "notion-tasks",
  description: "Check Notion for new tasks and summarise them daily",
...
3. Categorise by priority (P0, P1, P2)
...
description: >
  Triage GitHub notifications and issues. Categorise by priority,
  summarise new issues, flag PRs needing review. Use when the user
...
Review and categorise GitHub notifications, issues, and pull requests.
...
2. Categorise: PRs needing review, new issues, mentions, CI failures
3. Prioritise by label: bug > security > feature > question
4. Summarise top items with direct links
