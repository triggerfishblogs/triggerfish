...
::: info For Google Calendar, use the [Google Workspace](/en-GB/integrations/google-workspace)
...
- [Google Workspace](/en-GB/integrations/google-workspace) -- For Google Calendar
  (uses native API)
- [Cron and Triggers](/en-GB/features/cron-and-triggers) -- Schedule calendar-based
  agent actions
- [Classification Guide](/en-GB/guide/classification-guide) -- Choosing the right
