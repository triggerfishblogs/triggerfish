...
<h1>अपनी सदस्यता प्रबंधित करें</h1>
<p class="subtitle">साइन-इन लिंक प्राप्त करने के लिए अपना ईमेल दर्ज करें।</p>
<div class="account-form">
<input type="email" id="account-email" placeholder="you@example.com" />
<button id="account-btn">लिंक भेजें</button>
</div>
  ...
  btn.addEventListener('click', async () => {
    ...
    try {
      ...
      if (resp.ok) {
        ...
        msg.textContent = 'साइन-इन लिंक के लिए अपना ईमेल देखें। यह आपको बिलिंग पोर्टल पर ले जाएगा जहाँ आप अपनी योजना, भुगतान विधि अपडेट कर सकते हैं, या रद्द कर सकते हैं।'
      } else {
        const data = await resp.json().catch(() => ({}))
        msg.className = 'account-message error'
        msg.textContent = data.error || 'कुछ गलत हो गया। कृपया पुनः प्रयास करें।'
      }
    } catch {
      msg.className = 'account-message error'
      msg.textContent = 'सर्वर से संपर्क नहीं हो सका। कृपया पुनः प्रयास करें।'
    }

    msg.style.display = ''
    btn.disabled = false
    btn.textContent = 'लिंक भेजें'
  })
