...
En servidores sin entorno de escritorio, el daemon GNOME Keyring / Secret Service puede no estar ejecutándose. Consulta [Solución de problemas de secrets](/pt-BR/support/troubleshooting/secrets) para instrucciones de configuración.
