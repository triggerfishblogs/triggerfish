...
- [Regla de no write-down](/pt-BR/security/no-write-down) — la regla de flujo de clasificación que
  la delegación aplica
- [Identidad y autenticación](/pt-BR/security/identity) — cómo se establece la identidad de usuario y canal
- [Auditoría y cumplimiento](/pt-BR/security/audit-logging) — cómo se registran las cadenas de delegación en
