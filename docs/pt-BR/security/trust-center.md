...
[Diseño con seguridad primero](/pt-BR/security/) para la explicación técnica
detallada.
...
| Programa de divulgación responsable      | <StatusBadge status="active" />  | Proceso documentado de reporte de vulnerabilidades con tiempos de respuesta definidos. Ver [política de divulgación](/pt-BR/security/responsible-disclosure). |
...
[Defensa en profundidad](/pt-BR/architecture/defense-in-depth).
...
[Política de divulgación responsable](/pt-BR/security/responsible-disclosure). No
