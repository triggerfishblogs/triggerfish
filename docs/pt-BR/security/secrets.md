...
- [Regla de no write-down](/pt-BR/security/no-write-down) — cómo los controles de clasificación
  complementan el aislamiento de credenciales
- [Identidad y autenticación](/pt-BR/security/identity) — cómo la identidad del usuario alimenta el
  acceso delegado a credenciales
- [Auditoría y cumplimiento](/pt-BR/security/audit-logging) — cómo se registran los eventos de acceso
  a credenciales
