...
- [Regla de no write-down](/pt-BR/security/no-write-down) — la regla de flujo de clasificación cuya
  aplicación se registra
- [Identidad y autenticación](/pt-BR/security/identity) — cómo se registran las decisiones de identidad
- [Delegación de agentes](/pt-BR/security/agent-delegation) — cómo las cadenas de delegación aparecen en
  los registros de auditoría
- [Gestión de secretos](/pt-BR/security/secrets) — cómo se registra el acceso a credenciales
