...
::: warning SECURITY
The LLM never chooses memory classification. It is always forced to the current session's taint level by the policy layer. This is a hard boundary that cannot be configured away.
:::
