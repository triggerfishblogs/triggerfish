...
monitoring behavior through `TRIGGER.md`. Your agent can deliver morning
...
analyze image files on disk. Configure a separate vision model to automatically
...
maps directory trees, detects coding patterns, traces imports, and analyzes git
