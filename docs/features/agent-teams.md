...
5. The lead synthesizes results and decides when the work is done
...
- Is authorized to disband the team
...
a result. **Use teams** when the task benefits from multiple specialized
