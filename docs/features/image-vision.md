...
from your clipboard in the CLI or browser, and the agent can analyze image files
...
3. The vision model describes each image (you see an "Analyzing image..."
   spinner)
...
These events drive the "Analyzing image..." spinner in the CLI and Tidepool
interfaces.
