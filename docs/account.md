...
<button id="account-btn">Send link</button>
</div>
  ...
  btn.addEventListener('click', async () => {
    ...
    try {
      ...
      if (resp.ok) {
        ...
        msg.textContent = 'Check your email for a sign-in link. It will take you to the billing portal where you can update your plan, payment method, or cancel.'
      } else {
