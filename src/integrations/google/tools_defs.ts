...
function buildGmailSearchDef(): ToolDefinition {
  return {
    name: "gmail_search",
    description:
...
function buildGmailReadDef(): ToolDefinition {
  return {
    name: "gmail_read",
    description:
...
function buildGmailSendParams(): ToolDefinition["parameters"] {
  return {
...
function buildGmailSendDef(): ToolDefinition {
  return {
    name: "gmail_send",
    description: "Send an email via Gmail. Composes and sends a new message.",
    parameters: buildGmailSendParams(),
  };
}

function buildGmailLabelParams(): ToolDefinition["parameters"] {
  return {
    message_id: {
      type: "string",
...
function buildGmailLabelDef(): ToolDefinition {
  return {
    name: "gmail_label",
    description:
      "Add or remove labels from a Gmail message (e.g. mark as read, archive, star).",
    parameters: buildGmailLabelParams(),
  };
}
...
function buildCalendarListDef(): ToolDefinition {
  return {
    name: "calendar_list",
    description:
...
function buildCalendarCreateParams(): ToolDefinition["parameters"] {
  return {
...
function buildCalendarCreateDef(): ToolDefinition {
  return {
    name: "calendar_create",
    description: "Create a new Google Calendar event.",
    parameters: buildCalendarCreateParams(),
  };
}
...
function buildCalendarUpdateParams(): ToolDefinition["parameters"] {
  return {
...
function buildCalendarUpdateDef(): ToolDefinition {
  return {
    name: "calendar_update",
    description:
      "Update an existing Google Calendar event. Only specified fields are changed.",
    parameters: buildCalendarUpdateParams(),
  };
}

// ── Tasks helpers ──

function buildTasksListDef(): ToolDefinition {
  return {
    name: "tasks_list",
...
function buildTasksCreateDef(): ToolDefinition {
  return {
    name: "tasks_create",
...
function buildTasksCompleteDef(): ToolDefinition {
  return {
    name: "tasks_complete",
...
function buildDriveSearchDef(): ToolDefinition {
  return {
    name: "drive_search",
    description:
...
function buildDriveReadDef(): ToolDefinition {
  return {
    name: "drive_read",
    description:
...
function buildSheetsReadDef(): ToolDefinition {
  return {
    name: "sheets_read",
    description:
...
function buildSheetsWriteDef(): ToolDefinition {
  return {
    name: "sheets_write",
