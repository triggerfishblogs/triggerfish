...
export const TOOL_PROFILES: Readonly<Record<string, ToolProfile>> = {
  ...
  tidepool: [
    "exec_file", "exec_command", "todo", "memory", "secrets", "web",
    "plan", "browser", "tidepool", "sessions", "signal", "image",
  ...
  cli: [
    "exec_file", "exec_command", "todo", "memory", "secrets", "web",
    "plan", "browser", "sessions", "signal", "image", "explore",
  ...
  triggerSession: [
    "exec_file", "todo", "memory", "web", "google", "github", "caldav",
    "notion", "llmTask", "summarize", "healthcheck", "trigger", "skills",
    "cron", "simulate", "workflow",
  ],
  /** Cron jobs — sandboxed file tools only, no run_command. */
  cronJob: [
    "exec_file", "todo", "memory", "web", "google", "github", "caldav",
    "notion", "llmTask", "summarize", "healthcheck", "skills", "cron",
    "simulate", "workflow",
  ],
  /** Subagents — sandboxed file tools only, no run_command. */
  subagent: [
    "exec_file", "todo", "memory", "web", "google", "github", "caldav",
    "notion", "llmTask", "summarize", "healthcheck", "skills",
  ],
};
